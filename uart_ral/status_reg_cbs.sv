...
//--File name: status_reg_cbs.sv
//--Author: Nguyen Ngoc Man
//--Description:
//==================================================================================
class status_reg_cbs extends uvm_reg_cbs;
     `uvm_object_utils(status_reg_cbs)
     int no_pass;
     int no_fail;
     //=================================================================
     //----------------METHODs
     //=================================================================
     extern function new(string name = "status_reg_cbs");
     extern virtual task post_read(uvm_reg_item rw);
endclass: status_reg_cbs
     //=================================================================
     //----------------IMPLEMENTATION of all METHODs
     //=================================================================
 function status_reg_cbs::new(string name = "status_reg_cbs");
   super.new(name);
   no_fail = 0;
   no_pass = 0;
 endfunction
     //
task status_reg_cbs::post_read(uvm_reg_item rw);
