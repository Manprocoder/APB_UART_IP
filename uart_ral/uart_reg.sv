...
class txd_reg extends uvm_reg;
	...
	//
	//contructor
	//function new (string name = "txd_reg_fifo", int unsigned size = 8, int unsigned n_bits = 8, int has_cover = UVM_NO_COVERAGE);
		//super.new (name, size, n_bits, has_cover);
	//endfunction
...
class rxd_reg extends uvm_reg;
	...
	uvm_reg_field RXD;
	//contructor
	//function new (string name = "rxd_reg_fifo", int unsigned size = 8, int unsigned n_bits = 8, int has_cover = UVM_NO_COVERAGE);
		//super.new (name, size, n_bits, has_cover);
	//endfunction
