...
module uart_reg_bank(
	clk_i, rst_n_i, ctrl_wr_i, ctrl_en_i, ctrl_addr_i, ctrl_data_i,
    //
...
assign push_o = ctrl_en_i & ctrl_wr_i & (ctrl_addr_i == 3'd3);
assign pop_o = ctrl_en_i & !ctrl_wr_i & (ctrl_addr_i == 3'd4);
...
//total interrupt
assign int_req = pe_int | fe_int | tx_ov_int | rx_ov_int | break_int | rx_data_int;
`endif
//=============================================================
//------------------- INTERNAL ASSIGNMENT
//=============================================================
assign clr_status = ctrl_en_i & ctrl_wr_i & (ctrl_addr_i == 3'd1);
//
...
always@(posedge clk_i) begin
	...
	else if(ctrl_en_i & ctrl_wr_i) begin
        if(~busy_i) begin //UART is busy, configuration write acess is ignored
            case(ctrl_addr_i) 
