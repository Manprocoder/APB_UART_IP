...
//--File name: odd_parity_seq.sv
//--Author: Nguyen Ngoc Man
//--Description: check UART operation with odd parity type 
//--Configuration of this class is implemented in virtual_parity_type_seq class
//======================================================================================
import apb_pkg::*;
import uart_ral_pkg::*;
import env_pkg::*;
//
class odd_parity_seq#(SYS_CLK = 50_000_000, OVERSAMPLE = 16, BAUD_RATE=9600) extends uart_base_seq;
typedef odd_parity_seq#(SYS_CLK, OVERSAMPLE, BAUD_RATE) seq_name;
    ...
    int no_apb_trans;
	//
	function new(string name = "odd_parity_seq");
		super.new(name);
        i = 0;
        no_apb_trans = 0;
	endfunction
